...
import { ArrowLeft, Package, Shield, CheckCircle } from 'lucide-react';
...
interface FoundUserSignInProps {
  onSuccess: () => void;
  onBack: () => void;
}

export default function FoundUserSignIn({ onSuccess, onBack }: FoundUserSignInProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E6F0FF] via-teal-50 to-green-50 py-12 px-4 flex items-center justify-center">
      <motion.div
      ...
      >
        ...
        <Card className="p-8 md:p-10 bg-white/90 backdrop-blur-sm shadow-2xl border-2 border-teal-100">
          <motion.div
          ...
          >
            ...
            <h2 className="mb-2 bg-gradient-to-r from-teal-600 to-teal-400 bg-clip-text text-transparent">
              Found Item Portal - Sign In
            </h2>
